				...
				<div class="row">
					...
					<div class="col-md-9">
						<div class="dreamcrub">
							...
							<ul class="previous">
								<li><a href="${pageContext.request.contextPath}/product/index.jsp">Back to Previous Page</a></li>
							</ul>
							<div class="clearfix"></div>
						</div>
						<div class="account_grid">
							<div class="col-md-6 login-left">
								...
								<p>By creating an account with our store, you will be able
									...
									and more.</p>
								<a class="acount-btn" href="${pageContext.request.contextPath}/product/register.jsp">Create an Account</a>
							</div>
							<div class="col-md-6 login-right">
								...
								<form id="loginAction_home" name="form1"
									...
									<div>
										<span>Email Address<label>*</label></span> <input type="text" name="loginUserDto.name">
									</div>
									<div>
		...
		<div class="instagram_top">
			...
			<ul class="instagram_grid">
				...
				<li class="last_instagram"><a class="popup-with-zoom-anim"
					href="#small-dialog1"><img src="${pageContext.request.contextPath}/images/i6.jpg"
